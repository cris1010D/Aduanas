...
/**
 * Configuracion de seguridad para ms-menores (defensa en profundidad).
 *
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // INSPECTOR puede consultar menores y autorizaciones
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/**")
                    .hasAnyRole("SUPERVISOR", "OFICIAL", "INSPECTOR", "VIAJERO")
                // VIAJERO puede crear sus propias declaraciones/registros
                .requestMatchers(HttpMethod.POST, "/**").hasAnyRole("SUPERVISOR", "OFICIAL", "INSPECTOR", "VIAJERO")
